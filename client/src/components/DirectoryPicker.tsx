...
export function DirectoryPicker({
  ...
  const {
    ...
    refetch: refetchDir,
  } = trpc.fileBrowser.listDirectory.useQuery(
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <ChevronRight
          className={`w-5 h-5 text-purple-400 transition-transform ${isOpen ? "rotate-90" : ""}`}
        />
      </button>
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-3 border-b border-purple-500/20 flex items-center justify-between">
              <h3 className="font-orbitron text-sm text-purple-200">
                Select Project
              </h3>
              <button
            ...
            <div className="p-2 border-b border-purple-500/20">
              <p className="text-xs text-purple-400/60 px-2 mb-2">
                Quick Paths
              </p>
              <button
                  ...
                  {dirData?.breadcrumbs.map((crumb, idx) => (
                    <span key={crumb.path} className="flex items-center">
                      ...
                      <button
                        ...
                        className={
                          idx === (dirData?.breadcrumbs.length || 0) - 1
                            ? "text-purple-300"
                    ...
                    <div className="p-1 space-y-0.5">
                      {dirData?.parentPath && (
                        <button
                          ...
                          onClick={() => {
                            setBrowsePath(dirData.parentPath!);
                            setSelectedPath(null);
                          }}
                        >
                      ...
                      {dirData?.entries.map(entry => (
                        <button
                          ...
                          onClick={() =>
                            setSelectedPath(
                              entry.path === selectedPath ? null : entry.path
                            )
                          }
                          onDoubleClick={() => {
                        ...
                        >
                          <Folder
                            className={`w-3 h-3 ${selectedPath === entry.path ? "text-purple-400" : "text-cyan-500"}`}
                          />
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-purple-400/50 font-mono truncate">
                            {project.path}
                          </p>
                        </div>
