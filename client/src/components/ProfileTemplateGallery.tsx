...
export function ProfileTemplateGallery({ onImport }: ProfileTemplateGalleryProps) {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start gap-3 mb-3">
                      <div className={`p-2 rounded-lg bg-gray-900/50 ${iconColorClasses[template.color] || 'text-purple-400'}`}>
                    ...
                    <div className="flex gap-2 text-[10px] text-gray-400 mb-3">
                      ...
                      <span className="px-1.5 py-0.5 rounded bg-gray-900/50">
                        {template.codeGeneration === 'none' ? 'no code' : template.codeGeneration}
                      </span>
                      <span className="px-1.5 py-0.5 rounded bg-gray-900/50">
              ...
              <DialogHeader>
                <div className="flex items-center gap-3">
                  {(() => {
                    ...
                    return (
                      <div className={`p-2 rounded-lg bg-gray-800 ${iconColorClasses[templateDetail.color] || 'text-purple-400'}`}>
                        <Icon className="h-6 w-6" />
                      </div>
                    );
                  })()}
                  <div>
                    <DialogTitle className="text-xl">{templateDetail.name}</DialogTitle>
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="p-3 rounded-lg bg-gray-800/50">
                    ...
                    <p className="font-medium text-white capitalize">{templateDetail.outputStyle}</p>
                  </div>
                  <div className="p-3 rounded-lg bg-gray-800/50">
                    <p className="text-xs text-gray-400 mb-1">Code Generation</p>
                    <p className="font-medium text-white capitalize">
                      {templateDetail.codeGeneration === 'none' ? 'No Code' : templateDetail.codeGeneration}
                    </p>
                  </div>
                  <div className="p-3 rounded-lg bg-gray-800/50">
      ...
      <Dialog open={showImportDialog} onOpenChange={setShowImportDialog}>
        <DialogContent className="bg-gray-900 border-gray-700">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a custom profile from this template. You can customize it after importing.
            </DialogDescription>
          </DialogHeader>
