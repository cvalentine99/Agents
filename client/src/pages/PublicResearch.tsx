...
export default function PublicResearch() {
  ...
  const {
    ...
    isLoading,
    error,
  } = trpc.research.getPublic.useQuery(
    { shareToken },
    { enabled: !!shareToken }
  );
        ...
        <Card className="bg-slate-900/50 border-red-500/30 max-w-md">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-slate-400">
              This research may have been removed or the link is invalid.
            </p>
          </CardContent>
        </Card>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950/20 to-slate-950">
      ...
      <div className="container py-8">
            ...
            <Tabs defaultValue="summary" className="w-full">
              <TabsList className="bg-slate-800/50 border border-slate-700">
                ...
                <TabsTrigger
                  ...
                  className="data-[state=active]:bg-purple-600"
                >
                  Findings ({research.findings?.length || 0})
                </TabsTrigger>
                <TabsTrigger
                  value="followups"
                  className="data-[state=active]:bg-purple-600"
                >
                  Q&A ({research.followUps?.length || 0})
                </TabsTrigger>
              </TabsList>
                            ...
                            <div className="mt-2 flex items-center gap-2">
                              <div className="flex-1 h-1 bg-slate-700 rounded-full overflow-hidden">
                                <div
                                  ...
                                  style={{
                                    width: `${finding.relevanceScore}%`,
                                  }}
                                />
                              </div>
                              <span className="text-xs text-slate-500">
                                {finding.relevanceScore}% relevant
                              </span>
                            </div>
                          </CardContent>
                        </Card>
        ...
        <div className="mt-8 text-center text-slate-500 text-sm">
          <p>
            Powered by{" "}
            <span className="text-purple-400">Agents by Valentine RF</span> -
            Deep Research
          </p>
        </div>
      </div>
